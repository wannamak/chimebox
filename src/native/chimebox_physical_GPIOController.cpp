#include "chimebox_physical_GPIOController.h"
...
JNIEXPORT jlong JNICALL Java_chimebox_physical_GPIOController_initializeOutput(
  ...
  // This is never freed.
  struct chimebox_gpio_context *context = new chimebox_gpio_context;
...
JNIEXPORT jint JNICALL Java_chimebox_physical_GPIOController_setInternal(
  ...
  struct chimebox_gpio_context *context = (struct chimebox_gpio_context *) context_ptr;
